...
# ==================================================
# POCO F6 PERFORMANCE OPTIMIZATIONS
# ==================================================

# ART/Dalvik оптимизации
PRODUCT_DEX_PREOPT_DEFAULT_FLAGS := --compiler-filter=speed
PRODUCT_DEX_PREOPT_BOOT_FLAGS := --compiler-filter=speed
WITH_DEXPREOPT := true
DONT_DEXPREOPT_PREBUILTS := false

# Отключение избыточного логирования (экономит CPU)
TARGET_USES_LOGD := false
TARGET_USES_LOGCAT := false

# Wi-Fi оптимизации
WIFI_HIDL_FEATURE_DUAL_INTERFACE := true
WIFI_HIDL_FEATURE_AWARE := true

# Графика - принудительное использование GPU для 2D
PRODUCT_PROPERTY_OVERRIDES += \
    debug.composition.type=gpu \
    debug.sf.hw=1 \
    persist.sys.ui.hw=1

# Оптимизация компилятора (если поддерживается)
TARGET_USE_O3 := true
